...
I was one of the only front end developers for this project originally as our department at meowwolf was very small at this point. Denver was an exciting challenge as there was a requirement that it have a lot of motion and movement.

Our design team came up with what the animations should be and part of my challenge was to translate the animation suggestions into actual experience.

After much research, I decided to use GreenSock to custom build out all the animations shown below.
...
```js
  ...
  var highlightAnim = function highlightAnim(SMController) {
    ...
    var scene = new ScrollMagic.Scene({ triggerElement: '.highlight', duration: 650 });
